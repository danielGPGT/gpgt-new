-- Fixed Migration Script: Old Quotes Table to New Clean Schema
-- This script safely handles the existing quotes table structure
...
-- Handle missing columns gracefully with COALESCE
